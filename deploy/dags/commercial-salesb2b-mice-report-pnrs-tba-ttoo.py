...
with models.DAG(
        ...
        tags=["commercial", "salesb2b", "mice", "pnrs_tba_ttoo"],
        catchup=False,
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-pnrstbattoo",
        ...
        arguments=['-m', 'reports.pnrs_tba_ttoo', '--start_date', "{{ params.start_date }}", '--end_date',
                   "{{ params.end_date }}"],
        env_vars={

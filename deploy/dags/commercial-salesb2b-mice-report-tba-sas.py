...
with models.DAG(
        ...
        schedule_interval=None if environment == "dev" else "30 7 * * *",
        tags=["commercial", "salesb2b", "mice", "report", "Tba sas"],
        catchup=False
) as dag:
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-groups-tba-sas",
        ...
        arguments=f'-m reports.tba_sas'.split(),
        env_vars={

...
with models.DAG(
        ...
        schedule_interval=None if environment == "dev" else "0 0 * * 5", #Cambio schedule VYTECH25-931
        tags=["commercial", "salesb2b", "mice", "report", "reassignment", "ancillaries"],
        catchup=False
) as dag:
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-reassignment-ancillaries",
        ...
        arguments='-m reports.reassignment_ancillaries'.split(),
        env_vars={
        ...
        container_resources=define_capacity("XL_container_resources"), ##

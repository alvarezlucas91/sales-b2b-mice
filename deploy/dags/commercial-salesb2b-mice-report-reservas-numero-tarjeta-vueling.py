...
with models.DAG(
        ...
        tags=["commercial", "salesb2b", "mice", "reservas-numero-tarjeta-vueling"],
        catchup=False
) as dag:
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-reservas-numero-tarjeta-vueling",
        ...
        arguments=f'-m reports.reservas_numero_tarjeta_vueling'.split(),
        env_vars={

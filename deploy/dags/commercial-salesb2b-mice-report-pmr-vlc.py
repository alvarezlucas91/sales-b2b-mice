...
with models.DAG(
        ...
        tags=["commercial", "salesb2b", "mice", "report", "pmr_vlc"],
        catchup=False,
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-pmr-vlc",
        ...
        arguments=['-m', 'reports.pmr_vlc','--start_date','{{params.start_date}}','--end_date','{{params.end_date}}'],
        env_vars={

...
with models.DAG(
        ...
        tags=["commercial", "salesb2b", "mice", "ttoo", "sundio"],
        catchup=False,
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-sundio",
        ...
        arguments=['-m', 'reports.ttoo', '--num_iata', num_iata, '--nom_iata', nom_iata, '--today_date', "{{params.today_date}}"],
        env_vars={

...
with models.DAG(
        ...
        schedule_interval=None if environment == "dev" else "0 8 * * *",
        tags=["commercial", "salesb2b", "mice", "report", "booking groups touroperation charter"],
        catchup=False
) as dag:
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-groups-touroperation-charter",
        ...
        arguments=f'-m reports.groups_touroperation_charter'.split(),
        env_vars={

...
with models.DAG(
        ...
        schedule_interval=None if environment == "dev" else "30 8 15 * *",
        tags=["commercial", "salesb2b", "mice", "report", "pax_no_show_gcharter"],
        catchup=False
) as dag:
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-pax-no-show-gcharter",
        ...
        arguments=f'-m reports.pax_no_show_gcharter'.split(),
        env_vars={

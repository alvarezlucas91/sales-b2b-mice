...
with models.DAG(
        ...
        schedule_interval=None if environment == "dev" else "0 0 1 * *",
        tags=["commercial", "salesb2b", "mice", "report", "iberia","ancillaries","gonow"],
        catchup=False
) as dag:
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-ancillaries-gonow",
        ...
        arguments=f'-m reports.iberia_ancillaries_gonow'.split(),
        env_vars={

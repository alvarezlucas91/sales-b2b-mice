...
with models.DAG(
        ...
        tags=["commercial", "salesb2b", "mice", "report", "plusgrade","huagati"],
        catchup=False
) as dag:
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-plusgrade_huagati",
        ...
        arguments=f'-m reports.plusgrade_huagati'.split(),
        env_vars={
        ...
        container_resources=define_capacity("L_container_resources"), #### VYTECH25-1334

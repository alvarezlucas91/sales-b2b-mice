...
with models.DAG(
        ...
        tags=["commercial", "salesb2b", "mice", "report", "monitorizacion_bundles_diario"],
        catchup=False
) as dag:
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-monitorizacion-bundles-diario",
        ...
        arguments=f'-m reports.monitorizacion_bundles_diario'.split(),
        env_vars={

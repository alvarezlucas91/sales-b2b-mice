...
with models.DAG(
        ...
        schedule_interval=None if environment == "dev" else "50 23 * * *",
        tags=["commercial", "salesb2b", "mice", "monitorizacion-ventas-diario"],
        catchup=False
) as dag:
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-monitorizacion-ventas-diario",
        ...
        arguments=f'-m reports.monitorizacion_ventas_diario'.split(),
        env_vars={

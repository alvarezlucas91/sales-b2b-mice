...
with models.DAG(
        ...
        schedule_interval=None if environment == "dev" else "0 9 1 * *",
        tags=["commercial", "salesb2b", "mice", "report", "ngcb_disruption", "ods-nav"],
        catchup=False
) as dag:
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-ngcb-disruption",
        ...
        arguments=f'-m reports.ngcb_disruption'.split(),
        env_vars={

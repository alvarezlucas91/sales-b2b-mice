...
with models.DAG(
        ...
        schedule_interval=None if environment == "dev" else "30 8 * * 2", #Cambio schedule VYTECH25-762
        tags=["commercial", "salesb2b", "mice", "report", "creditshell"],
        catchup=False,
        params={
            "start_date": Param(
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-creditshell",
        ...
        arguments=['-m', 'reports.creditshell', '--start_date', '{{params.start_date}}', '--end_date',
                   '{{params.end_date}}'],
        env_vars={

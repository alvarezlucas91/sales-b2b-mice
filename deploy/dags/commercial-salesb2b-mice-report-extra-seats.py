...
with models.DAG(
        ...
        schedule_interval=None if environment == "dev" else "30 8 * * *",
        tags=["commercial", "salesb2b", "mice", "report", "extra_seats","ods-nav"],
        catchup=False,
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-extraseats",
        ...
        arguments=['-m', 'reports.extra_seats', '--start_date', "{{ params.start_date }}", '--end_date',
                   "{{ params.end_date }}"],
        env_vars={

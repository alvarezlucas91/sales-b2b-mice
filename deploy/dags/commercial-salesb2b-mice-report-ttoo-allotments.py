...
with models.DAG(
        ...
        schedule_interval=None if environment == "dev" else "30 10 * * *",
        tags=["commercial", "salesb2b", "mice", "report", "ttoo allotments"],
        catchup=False
) as dag:
    ...
    run_pod = KubernetesPodOperator(
        task_id="salesb2b-mice-report-ttoo-allotments",
        ...
        arguments=f'-m reports.ttoo_allotments'.split(),
        env_vars={
